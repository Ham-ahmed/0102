...
echo -e "${CYAN}"
echo "################################################################"
echo "#  Start downloading and installing ultracam-oscam_11942-r803  #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/0102/refs/heads/main/enigma2-plugin-softcams-ultracam-oscam_11942-emu-r802_all.ipk"
IPK_NAME="enigma2-plugin-softcams-ultracam-oscam_11942-emu-r802_all.ipk"
