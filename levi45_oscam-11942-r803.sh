...
echo -e "${CYAN}"
echo "################################################################"
echo "#  Start downloading and installing levi45_oscam-11942-r803    #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/0102/refs/heads/main/enigma2-plugin-softcams-oscam-emu-levi45_11942-803_all.ipk"
IPK_NAME="enigma2-plugin-softcams-oscam-emu-levi45_11942-803_all.ipk"
